#!/usr/bin/env python3
"""
Test script for onoff read command
"""
import asyncio
import websockets
import json
...
async def test_onoff_read():
    uri = "ws://localhost:9002"
    
    print("=== Testing onoff read command ===\n")
    ...
    async with websockets.connect(uri) as websocket:
        ...
        print("\n✅ onoff read command SUCCESSFUL")
        return True

if __name__ == "__main__":
    success = asyncio.run(test_onoff_read())
    if not success:
        exit(1)
